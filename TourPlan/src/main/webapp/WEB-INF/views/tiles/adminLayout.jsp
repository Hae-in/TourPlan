      ...
      <div class="row">
        ...
        <div class="col-lg-3 mb-4">
          <div class="list-group">
            <a href="<c:url value='/'/>admin/member.do" class="list-group-item">회원관리</a>
            <a href="<c:url value='/'/>admin/plan.do" class="list-group-item">일정관리</a>
            <a href="<c:url value='/'/>admin/place.do" class="list-group-item">명소관리</a>
            <a href="<c:url value='/'/>admin/report.do" class="list-group-item">신고관리</a>
            <a href="<c:url value='/'/>admin/helpdesk.do" class="list-group-item">고객센터</a>
            <a href="<c:url value='/'/>admin/category.do" class="list-group-item">카테고리관리</a>
          </div>
        </div>
        <!-- Content Column -->
