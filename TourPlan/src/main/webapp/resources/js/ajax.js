var ajax = {};	//ajax 빈 객체 생성	--> 패키지로 활용
ajax.xhr = {};	

ajax.xhr.Request = function(url, params, callback, method, applyObj, method_param) {
	this.url = url;
	this.params = params;
...
ajax.xhr.Request.prototype = {
	...
	onStateChange: function() {
		if (this.applyObj) {
			this.callback.call(this.applyObj, this.req, this.method_param);
		} else {
			this.callback(this.req, this.method_param);
		}
	}
}
