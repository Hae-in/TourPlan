...
redips.init = function () {
	...
	rd.event.dropped = function () {
		...
		send("insert", plantablenum, plannum, day, 30, 5, 0, tr, placenum, child1, child2);
		
		tr = rd.td.previous.getAttribute("id");
		arr = tr.split("a");
		day = arr[0];
		tr = arr[1];
		console.log("이전것 " + "day : " + day + " tr : " + tr + " placenum : " + placenum);
		
		send("delete", plantablenum, plannum, day, 30, 5, 0, tr, placenum, "", "");
		}
	};
